...
namespace O3DWB
{
    public static class Octave3DConfigXMLInfo
    {
        ...
        public static string IgnoreObjectsWhenSnappingNode { get { return "IgnoreObjectsWhenSnapping"; } }
        ...
        public static string AttachMirroredSelectedObjectsToActiveGroupNodeNode { get { return "AttachMirroredObjectsToActivegroup"; } }
