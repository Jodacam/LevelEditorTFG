    ...
    public class ObjectPlacementPathManualConstructionSession
    {
        ...
        public void Attach2NewSegments()
        {
            if(_isActive)
            {
                ...
                if (CanRotateObjectsToFollowPath()) newPenultimateSegment.LookStacksAlongExtensionDirection();
        ...
        private void ExtendOrShrinkPathAlongExtensionPlane()
        {
            ...
            if (MouseCursor.Instance.IntersectsPlane(extensionPlane, out extensionPlaneIntersectionPoint))
            {
                ...
                if (!PenultimateSegment.ExtensionDirection.IsPointingInSameGeneralDirection(toIntersectionPoint)) PenultimateSegment.ReverseExtensionDirection();
