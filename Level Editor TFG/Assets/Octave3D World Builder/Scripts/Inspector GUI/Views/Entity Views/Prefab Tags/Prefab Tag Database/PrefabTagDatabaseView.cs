...
namespace O3DWB
{
    ...
    public class PrefabTagDatabaseView : EntityView
    {
        ...
        protected override void RenderContent()
        {
            ...
            else EditorGUILayoutEx.InformativeLabel("There are no prefab tags to display.");
        ...
        {
            ViewData.TagScrollPosition = EditorGUILayout.BeginScrollView(ViewData.TagScrollPosition, GetStyleForTagScrollView(), GUILayout.Height(PrefabTagDatabaseViewData.TagScrollViewHeight));
        ...
        {
            RenderCreateNewTagControls();
            RenderActivateDeactivateAllTagsButtons();
            RenderActivateDeactivateOnlyFilteredTagsButtons();
        ...
        private void RenderCreateNewTagControls()
        {
            EditorGUILayout.BeginHorizontal();
        ...
        {
            if (GUILayout.Button(GetContentForCreateNewTagButton(), GUILayout.Width(EditorGUILayoutEx.PreferedActionButtonWidth)))
            {
        ...
        private void RenderActivateDeactivateAllTagsButtons()
        {
            EditorGUILayout.BeginHorizontal();
        ...
        {
            if (GUILayout.Button(GetContentForActivateAllTagsButton(), GUILayout.Width(EditorGUILayoutEx.PreferedActionButtonWidth)))
            {
        ...
        {
            if (GUILayout.Button(GetContentForDeactivateAllTagsButton(), GUILayout.Width(EditorGUILayoutEx.PreferedActionButtonWidth)))
            {
                UndoEx.RecordForToolAction(_prefabTagDatabase.GetAllPrefabTags());
        ...
        private void RenderActivateDeactivateOnlyFilteredTagsButtons()
        {
            EditorGUILayout.BeginHorizontal();
        ...
        {
            if (GUILayout.Button(GetContentForActivateOnlyFilteredTagsButton(), GUILayout.Width(EditorGUILayoutEx.PreferedActionButtonWidth)))
            {
                UndoEx.RecordForToolAction(_prefabTagDatabase);
        ...
        {
            if (GUILayout.Button(GetContentForDeactivateOnlyFilteredTagsButton(), GUILayout.Width(EditorGUILayoutEx.PreferedActionButtonWidth)))
            {
                UndoEx.RecordForToolAction(_prefabTagDatabase);
        ...
        {
            if (GUILayout.Button(GetContentForRemoveAllTagsButton(), GUILayout.Width(EditorGUILayoutEx.PreferedActionButtonWidth)))
            {
                UndoEx.RecordForToolAction(_prefabTagDatabase);
