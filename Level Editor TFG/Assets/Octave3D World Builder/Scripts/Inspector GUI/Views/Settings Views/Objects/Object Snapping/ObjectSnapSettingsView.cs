...
namespace O3DWB
{
    ...
    public class ObjectSnapSettingsView : SettingsView
    {
        ...
        protected override void RenderContent()
        {
            ...
            Octave3DWorldBuilder.ActiveInstance.ShowGUIHint("It is recomenned to use the \'Box\' snap mode when dealing with tiles/blocks/cubes etc. Use \'Vertex\' when dealing with more " +
                                                      "irregular objects.");
