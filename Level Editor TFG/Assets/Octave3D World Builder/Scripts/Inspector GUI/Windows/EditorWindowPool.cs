...
namespace O3DWB
{
    ...
    public class EditorWindowPool : MonoBehaviour
    {
        ...
        [SerializeField]
        private Octave3DFixWindow _octave3DFixWindow;
        ...
        public Octave3DFixWindow Octave3DFixWindow
        {
            get
            {
                if (_octave3DFixWindow == null) _octave3DFixWindow = CreateWindow<Octave3DFixWindow>();
                return _octave3DFixWindow;
            }
        }
