...
namespace O3DWB
{
    public static class EditorGUILayoutEx
    {
        ...
        public static void InformativeLabel(string labelText, bool requireWordWrap = true)
        {
            Color labelColor = EditorGUIUtility.isProSkin ? Color.white : Color.black;
            EditorGUILayout.LabelField(labelText, EditorGUIStylesFactory.CreateInformativeLabelStyle(labelColor, requireWordWrap));
        }

        public static void InformativeLabel(string labelText, Color labelColor, bool requireWordWrap = true)
        {
            EditorGUIColor.Push(labelColor);
            EditorGUILayout.LabelField(labelText, EditorGUIStylesFactory.CreateInformativeLabelStyle(labelColor, requireWordWrap));
            EditorGUIColor.Pop();
        }
