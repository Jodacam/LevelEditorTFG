...
namespace O3DWB
{
    public static class Vector2Extensions
    {
        ...
        {
            return camera.ScreenToWorldPoint(new Vector3(point2D.x, point2D.y, camera.nearClipPlane + distanceFromCamNearPlane));
        }
        #endregion
        ...
        public static List<Vector2> GetScreenPoints(List<Vector3> worldPoints, Camera camera)
        {
            ...
            {
                screenPoints.Add(camera.WorldToScreenPoint(worldPoint));
            }
