...
namespace O3DWB
{
    ...
    public class SnapSurface
    {
        ...
        public void RenderGizmos()
        {
            ...
            if (IsValid && _type == SnapSurfaceType.ObjectCollider && _surfaceObject != null) _objectBoxSnapSurfaceGrid.RenderGizmos();
        }
        ...
        public void FromMouseCursorRayHit(MouseCursorRayHit cursorRayHit)
        {
            ...
            if (cursorRayHit.WasAnObjectHit && !ObjectSnapSettings.Get().IgnoreObjectsWhenSnapping)
            {
